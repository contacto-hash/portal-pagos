// Minimal Payment Tracking Portal
...
<header class="topbar">
  ...
  <span style="float:right">
    ${admin ? `<span class="muted">Admin: ${admin}</span> <a href="/admin/logout">Salir</a>` : user ? `<a href="/me">Mi estado</a> <a href="/logout">Salir</a>` : `<a href="/login">Ingresar</a>`}
  </span>
</header>
<main>
${body}
...
app.get("/login", (req, res) => {
  ...
  <div class="card">
    ...
    <form method="POST" action="/login">
      ...
      <p class="muted">Tu administrador te entrega un código. (Más adelante se puede cambiar a login por email OTP.)</p>
